...
const NAV_ITEMS = [
  { href: '/cic', label: 'Overview' },
  { href: '/cic/config', label: 'Config' },
  { href: '/cic/cookies', label: 'Cookies' },
  { href: '/cic/logs', label: 'Logs' },
  { href: '/cic/schedules', label: 'Schedules' },
];
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-semibold text-white">
              live-player control center
            </h1>
            <p className="mt-1 text-sm text-slate-300">
              Route-first operations UI for config, cookies, logs, and schedules.
            </p>
          </div>
