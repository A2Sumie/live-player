...
var BuildId = "9h3D6LHt4Slf_ihzuYXBD";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!api|_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "9h3D6LHt4Slf_ihzuYXBD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "/Q4UYg2i6VmOeTWdM7T6FjS0kSGgtX0DQ39zFWiyMas=", "__NEXT_PREVIEW_MODE_ID": "3284ed935ef5cb92cd528e2e3bd93ae4", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "94586f086c7b102dc04b2f154833cffa2884cfe28c0baf1e3126fa193c73ae68", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "23a69d0c2e59d6ef0bf43a1e3cb0935df8684fb79a73b491dd97c93485ea6d2f" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admins/route": "/api/admins", "/api/admins/[id]/route": "/api/admins/[id]", "/api/auth/login/route": "/api/auth/login", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/me/route": "/api/auth/me", "/api/config/crawlers/route": "/api/config/crawlers", "/api/config/route": "/api/config", "/api/config/update/route": "/api/config/update", "/api/cookies/list/route": "/api/cookies/list", "/api/cron/execute-schedules/route": "/api/cron/execute-schedules", "/api/players/[id]/cover/route": "/api/players/[id]/cover", "/api/players/[id]/auto-capture/route": "/api/players/[id]/auto-capture", "/api/players/[id]/route": "/api/players/[id]", "/api/players/route": "/api/players", "/api/schedules/[id]/route": "/api/schedules/[id]", "/api/schedules/public/route": "/api/schedules/public", "/api/schedules/route": "/api/schedules", "/api/server/restart/route": "/api/server/restart", "/api/webhook/schedule/route": "/api/webhook/schedule", "/favicon.ico/route": "/favicon.ico", "/api/cookies/delete/route": "/api/cookies/delete", "/api/cookies/route": "/api/cookies", "/api/cookies/view/[finder]/route": "/api/cookies/view/[finder]", "/auth/login/page": "/auth/login", "/cic/page": "/cic", "/config/page": "/config", "/player/[id]/page": "/player/[id]", "/page": "/", "/cookies/page": "/cookies" };
